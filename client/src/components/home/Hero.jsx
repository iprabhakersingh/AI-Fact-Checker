        ...
        <>
            <div className="min-h-screen pb-20">
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h3 class="text-lg text-gray-700 text-center">Leading companies rely on Prebuiltui to make their website beautiful.</h3>
                    <div class="flex flex-wrap items-center justify-center gap-12 mt-14 max-md:px-2">
